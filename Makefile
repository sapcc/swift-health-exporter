...
build/cover.out: FORCE | build
	...
	@env $(GO_TESTENV) go test -shuffle=on -p 1 -coverprofile=build/coverprofile.out $(GO_BUILDFLAGS) -ldflags '-s -w -X github.com/sapcc/go-api-declarations/bininfo.binName=swift-health-exporter -X github.com/sapcc/go-api-declarations/bininfo.version=$(BININFO_VERSION) -X github.com/sapcc/go-api-declarations/bininfo.commit=$(BININFO_COMMIT_HASH) -X github.com/sapcc/go-api-declarations/bininfo.buildDate=$(BININFO_BUILD_DATE) $(GO_LDFLAGS)' -covermode=count -coverpkg=$(subst $(space),$(comma),$(GO_COVERPKGS)) $(GO_TESTFLAGS) $(GO_TESTPKGS)
...
help: FORCE
	...
	@printf "  \e[36mbuild/swift-health-exporter\e[0m                     Build swift-health-exporter.\n"
	@printf "  \e[36mbuild/mock-swift-dispersion-report\e[0m              Build mock-swift-dispersion-report.\n"
	@printf "  \e[36mbuild/mock-swift-dispersion-report-with-errors\e[0m  Build mock-swift-dispersion-report-with-errors.\n"
	@printf "  \e[36mbuild/mock-swift-recon\e[0m                          Build mock-swift-recon.\n"
	@printf "  \e[36mbuild/mock-swift-recon-with-errors\e[0m              Build mock-swift-recon-with-errors.\n"
